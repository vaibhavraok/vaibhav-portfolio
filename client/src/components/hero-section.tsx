...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="pt-16 pb-16 bg-gradient-to-br from-secondary via-gray-700 to-primary relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            >
              Turning ideas into reliable, user-centric software powered by clean
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
              <Button
                onClick={() =>
                  window.open(
                    profile?.resumeUrl || "https://github.com/vaibhavraok",
                    "_blank"
                  )
                }
              ...
              <Button
                ...
                className="border-2 border-white text-white px-6 py-3 rounded-lg bg-transparent hover:bg-white hover:text-secondary transition-colors"
            ...
            <div className="flex space-x-4">
              <Button
                ...
                onClick={() =>
                  window.open(
                    profile?.linkedinUrl ||
                      "https://linkedin.com/in/vaibhav-k-3b826631a",
                    "_blank"
                  )
                }
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    profile?.githubUrl || "https://github.com/vaibhavraok",
                    "_blank"
                  )
                }
                className="w-12 h-12 bg-gray-700 text-white rounded-lg hover:bg-primary transition-colors"
            ...
            <div className="relative">
              <div className="w-80 h-80 rounded-full p-2 bg-gradient-to-br from-primary to-accent">
                <img
                  ...
                  onError={(e) => {
                    (e.currentTarget as HTMLImageElement).src = profileImage;
                  }}
                />
              </div>
            </div>
